...
for entry in $full_file;do
    ...
    if [[ -n $extension ]];then
        ...
        if [[ -n $extension ]] ;then
            ...
            echo "use $dbname;update extension set nat='$nat', missedcalls='$missedcalls', context='$context', secret='$secret', firstname='$firstname', lastname='$lastname', sipcfg='$sipcfg', modified='1' where extension='$extension';"|mysql -u$dbuser -p$dbpassword
