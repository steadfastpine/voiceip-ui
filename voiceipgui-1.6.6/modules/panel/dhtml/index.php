...
<!--
function init() {
	new Ajax.Request('variables.php?context=<?php echo $contexto?>', {onSuccess:handlerFunc, onFailure:errFunc});
	loglines = new Array();
 tiempos = new Object();
	tipofree = new Object();
...
<param name="movie" value="comunicator.swf?context=<?php echo $contexto?>" />
<param name="quality" value="high" />
<param name="scale" value="noScale" />
<param name="bgcolor" value="#ffffff" />
<embed src="comunicator.swf?context=<?php echo $contexto?>" scale="noScale" quality="high" bgcolor="#ffffff" width="100" height="100" name="operator" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" swLiveConnect="true"/>
</div>
</body>
</html>
