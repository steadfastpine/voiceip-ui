...
if ($logged_in=="yes") {
    ...
    if (empty($fromstatsmonth)) {
        $fromstatsmonth=date('Y-m');
    }
    if (empty($tostatsmonth)) {
        $tostatsmonth=date('Y-m');
    }
    if (empty($fromstatsday_sday)) {
        $fromstatsday_sday=date('d');
    }
    if (empty($fromstatsmonth_sday)) {
        $fromstatsmonth_sday=date('Y-m');
    }
    if (empty($tostatsday_sday)) {
        $tostatsday_sday=date('d');
    }
    if (empty($tostatsmonth_sday)) {
        $tostatsmonth_sday=date('Y-m');
    }
    if (empty($Period)) {
        $Period=Month;
    }
    ...
    */
    ...
    <TBODY>
				    ...
				    ?>
                   		 ...
                   		 <TR bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$ligne_number%2]?>"  onMouseOver="bgColor='#C4FFD7'" onMouseOut="bgColor='<?=$FG_TABLE_ALTERNATE_ROW_COLOR[$ligne_number%2]?>'"> 
						    <TD vAlign=top align="<?php echo $FG_TABLE_COL[$i][3]?>" class=tableBody><? echo $ligne_number+$current_page*$FG_LIMITE_DISPLAY."."; ?></TD>
                  ...
                  <TBODY>
                    <TR> 
                      <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B> 
                        ...
                        <img src="images/fleche-g.gif" width="5" height="10"> <a href="<?php echo $PHP_SELF?>?s=1&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<? echo ($current_page-1)?><? if (!is_null($letter) && ($letter!="")){ echo "&letter=$letter";} 
                        ...
                        Previous </a> - 
                        <?php }?>
                        <?php echo ($current_page+1);?> / <? echo $nb_record_max;?> 
                        <?php if ($current_page<$nb_record_max-1){?>
                        - <a href="<?php echo $PHP_SELF?>?s=1&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<? echo ($current_page+1)?><? if (!is_null($letter) && ($letter!="")){ echo "&letter=$letter";} 
					    echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&sourcetype=$sourcetype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&userfieldtype=$userfieldtype&userfield=$userfield&accountcodetype=$accountcodetype&accountcode=$accountcode&duration1=$duration1&duration1type=$duration1type&duration2=$duration2&duration2type=$duration2type";?>"> 
    ...
    <!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	    <center>
	    <FORM METHOD=POST ACTION="<?php echo $PHP_SELF?>?s=<?=$s?>&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<?=$current_page?>">
		    ...
		    <table class="bar-status" width="100%" border="0" cellspacing="1" cellpadding="2" align="center">
			    <tbody><tr>
            		<td class="bar-search" align="left" bgcolor="#555577">
					    <input type="radio" name="Period" value="Month" <?php  if (($Period=="Month") || !isset($Period)){ ?>checked="checked" <? } ?>> 
					    <font  size="1" color="#ffffff"><b>Selection of the month</b></font>
				    </td>
          			<td class="bar-search" align="left" bgcolor="#cddeff">
					    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#cddeff"><tr><td>
	      				<input type="checkbox" name="frommonth" value="true" <?php  if ($frommonth){ ?>checked<?}?>> 
					    ...
					    <input type="checkbox" name="tomonth" value="true" <?php  if ($tomonth){ ?>checked<?}?>> 
			    ...
			    <tr>
            		<td align="left" bgcolor="#000033">
					    <input type="radio" name="Period" value="Day" <?php  if ($Period=="Day"){ ?>checked="checked" <? } ?>> 
					    <font  size="1" color="#ffffff"><b>Selection of the day</b></font>
				    </td>
          			<td align="left" bgcolor="#acbdee">
					    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#acbdee"><tr><td>
	      				<input type="checkbox" name="fromday" value="true" <?php  if ($fromday){ ?>checked<?}?>> From : 
					    ...
					    <input type="checkbox" name="today" value="true" <?php  if ($today){ ?>checked<?}?>> To : 
			    ...
			    <tr>
				    <td class="bar-search" align="left" bgcolor="#555577">			
					    <font  size="1" color="#ffffff"><b>DESTINATION</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#cddeff">
				    <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><INPUT TYPE="text" NAME="dst" value="<?php echo $dst?>"></td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="dsttype" value="1" <?php if((!isset($dsttype))||($dsttype==1)){?>checked<?}?>>Exact</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="dsttype" value="2" <?php if($dsttype==2){?>checked<?}?>>Begins with</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="dsttype" value="3" <?php if($dsttype==3){?>checked<?}?>>Contains</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="dsttype" value="4" <?php if($dsttype==4){?>checked<?}?>>Ends with</td>
				    </tr></table></td>
			    </tr>			
			    <tr>
				    <td align="left" bgcolor="#000033">					
					    <font  size="1" color="#ffffff"><b>SOURCE</b></font>
				    </td>				
				    ...
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="sourcetype" value="1" <?php if((!isset($sourcetype))||($sourcetype==1)){?>checked<?}?>>Exact</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="sourcetype" value="2" <?php if($sourcetype==2){?>checked<?}?>>Begins with</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="sourcetype" value="3" <?php if($sourcetype==3){?>checked<?}?>>Contains</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="sourcetype" value="4" <?php if($sourcetype==4){?>checked<?}?>>Ends with</td>
				    </tr></table></td>
			    </tr>
			    <tr>
				    <td class="bar-search" align="left" bgcolor="#555577">				
					    <font  size="1" color="#ffffff"><b>CLI</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#cddeff">
				    <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><INPUT TYPE="text" NAME="clid" value="<?php echo $clid?>"></td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="clidtype" value="1" <?php if((!isset($clidtype))||($clidtype==1)){?>checked<?}?>>Exact</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="clidtype" value="2" <?php if($clidtype==2){?>checked<?}?>>Begins with</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="clidtype" value="3" <?php if($clidtype==3){?>checked<?}?>>Contains</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="clidtype" value="4" <?php if($clidtype==4){?>checked<?}?>>Ends with</td>
				    </tr></table></td>
			    </tr>
			    <tr>
				    <td align="left" bgcolor="#000033">					
					    <font  size="1" color="#ffffff"><b>USERFIELD</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#acbdee">
				    ...
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="userfieldtype" value="1" <?php if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?}?>>Exact</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="userfieldtype" value="2" <?php if($userfieldtype==2){?>checked<?}?>>Begins with</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="userfieldtype" value="3" <?php if($userfieldtype==3){?>checked<?}?>>Contains</td>
				    <td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="userfieldtype" value="4" <?php if($userfieldtype==4){?>checked<?}?>>Ends with</td>
				    </tr></table></td>
			    </tr>
			    <tr>
				    <td class="bar-search" align="left" bgcolor="#555577">				
					    <font  size="1" color="#ffffff"><b>ACCOUNTCODE</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#cddeff">
				    ...
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="accountcodetype" value="1" <?php if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?}?>>Exact</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="accountcodetype" value="2" <?php if($accountcodetype==2){?>checked<?}?>>Begins with</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="accountcodetype" value="3" <?php if($accountcodetype==3){?>checked<?}?>>Contains</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="accountcodetype" value="4" <?php if($accountcodetype==4){?>checked<?}?>>Ends with</td>
				    </tr></table></td>
			    </tr>			
			    <tr>
			    <td align="left" bgcolor="#000033">					
					    <font  size="1" color="#ffffff"><b>CHANNEL</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#acbdee">
			    ...
			    <tr>
				    <td class="bar-search" align="left" bgcolor="#555577">				
					    <font  size="1" color="#ffffff"><b>DURATION</b></font>
				    </td>				
				    <td class="bar-search" align="left" bgcolor="#cddeff">
				    <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
				    <td><INPUT TYPE="text" NAME="duration1" size="4" value="<?php echo $duration1?>"></td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="4" <?php if($duration1type==4){?>checked<?}?>>&gt;</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="5" <?php if($duration1type==5){?>checked<?}?>>&gt; egal</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="1" <?php if((!isset($duration1type))||($duration1type==1)){?>checked<?}?>>Egal</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="2" <?php if($duration1type==2){?>checked<?}?>>&lt; egal</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="3" <?php if($duration1type==3){?>checked<?}?>>&lt;</td>	
				    ...
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="4" <?php if($duration2type==4){?>checked<?}?>>&gt;</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="5" <?php if($duration2type==5){?>checked<?}?>>&gt; egal</td>								
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="2" <?php if($duration2type==1){?>checked<?}?>>&lt; egal</td>
				    <td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="3" <?php if($duration2type==3){?>checked<?}?>>&lt;</td>	
				    </tr></table>
				    </td>
			    </tr>	
			    <tr>
				    ...
				    <td class="bar-search" align="center" bgcolor="#acbdee">
					    ...
					    Result : Minutes<input type="radio" NAME="resulttype" value="min" <?php if((!isset($resulttype))||($resulttype=="min")){?>checked<?}?>> - Seconds <input type="radio" NAME="resulttype" value="sec" <?if($resulttype=="sec"){?>checked<?}?>>
	      			</td>
        		</tr>
		    </tbody></table>
	    </FORM>
    ...
    <!-- TITLE GLOBAL -->
    <center>
     <table border="0" cellspacing="0" cellpadding="0" width="100%"><tbody><tr><td align="left" height="30">
		    <table cellspacing="0" cellpadding="1" bgcolor="#000000" width="50%"><tbody><tr><td>
			    <table cellspacing="0" cellpadding="0" width="100%"><tbody>
				    <tr><td bgcolor="#600101" align="left"><font  size="1" color="white"><b>TOTAL</b></font></td></tr>
			    </tbody></table>
		    </td></tr></tbody></table>
     </td></tr></tbody></table>
    ...
    <tbody><tr><td bgcolor="#000000">			
	    ...
	    <tr>	
        	...
        	<td bgcolor="#b72222" align="center" colspan="4"><font  size="1" color="#ffffff"><b>ASTERISK MINUTES</b></font></td>
        </tr>
	    <tr bgcolor="#600101">
		    <td align="right" bgcolor="#b72222"><font  size="1" color="#ffffff"><b>DATE</b></font></td>
            <td align="center"><font  size="1" color="#ffffff"><b>DURATION</b></font></td>
		    <td align="center"><font  size="1" color="#ffffff"><b>GRAPHIC</b></font></td>
		    <td align="center"><font  size="1" color="#ffffff"><b>CALLS</b></font></td>
		    <td align="center"><font  size="1" color="#ffffff"><b> <acronym title="Average Connection Time">ACT</acronym> </b></font></td>
	    ...
	    ?>
		    ...
		    <td align="right" class="sidenav" nowrap="nowrap"><font  size="1" color="#ffffff"><?php echo $data[0]?></font></td>
		    <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="right" nowrap="nowrap"><font  color="#000000" size="1"><?=$minutes?> </font></td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="left" nowrap="nowrap" width="<?=$widthbar+60?>">
            <table cellspacing="0" cellpadding="0"><tbody><tr>
            <td bgcolor="#e22424"><img src="images/spacer.gif" width="<?php echo $widthbar?>" height="6"></td>
            </tr></tbody></table></td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="right" nowrap="nowrap"><font  color="#000000" size="1"><?=$data[2]?></font></td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="right" nowrap="nowrap"><font  color="#000000" size="1"><?=$tmc?> </font></td>
         <?php 	 }	 	 	
	    ...
	    <tr bgcolor="#600101">
		    <td align="right" nowrap="nowrap"><font  size="1" color="#ffffff"><b>TOTAL</b></font></td>
		    <td align="center" nowrap="nowrap" colspan="2"><font  size="1" color="#ffffff"><b><?php echo $totalminutes?> </b></font></td>
		    <td align="center" nowrap="nowrap"><font  size="1" color="#ffffff"><b><?php echo $totalcall?></b></font></td>
		    <td align="center" nowrap="nowrap"><font  size="1" color="#ffffff"><b><?php echo $total_tmc?></b></font></td>                        
	    </tr>
	    <!-- FIN TOTAL -->
	      </tbody></table>
	      <!-- Fin Tableau Global //-->
